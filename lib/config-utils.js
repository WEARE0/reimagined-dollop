...
function getUnsupportedLanguagesError(languages) {
    return `Does not support the following languages: ${languages.join(", ")}`;
}
exports.getUnsupportedLanguagesError = getUnsupportedLanguagesError;
/**
...
function combinePacks(packs1, packs2) {
    ...
    for (const lang of Object.keys(packs1)) {
        packs[lang] = (_a = packs1[lang]) === null || _a === void 0 ? void 0 : _a.concat(packs2[lang] || []);
    }
