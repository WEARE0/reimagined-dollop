...
const linguistToMetrics = {
    ...
    go: languages_1.KnownLanguage.go,
    java: languages_1.KnownLanguage.java,
    javascript: languages_1.KnownLanguage.javascript,
    python: languages_1.KnownLanguage.python,
    ruby: languages_1.KnownLanguage.ruby,
