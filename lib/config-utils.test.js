...
(0, ava_1.default)("Unknown languages", async (t) => {
    return await util.withTmpDir(async (tmpDir) => {
        ...
        try {
            ...
            t.deepEqual(err, new Error(configUtils.getUnsupportedLanguagesError(["rubbish", "english"])));
        }
    });
});
    ...
    return await util.withTmpDir(async (tmpDir) => {
      ...
      `;
        ...
        t.deepEqual(packs, {
            ...
            [languages_1.KnownLanguage.python]: [
                {
                    packName: "c/d",
                    version: (0, semver_1.clean)("1.2.3"),
                },
...
function invalidPackNameMacro(t, name) {
    parsePacksErrorMacro(t, { [languages_1.KnownLanguage.cpp]: [name] }, [languages_1.KnownLanguage.cpp], new RegExp(`The configuration file "/a/b" is invalid: property "packs" "${name}" is not a valid pack`));
}
...
(0, ava_1.default)("two packs with language", parsePacksMacro, {
    ...
    [languages_1.KnownLanguage.java]: ["d/e", "f/g@1.2.3"],
}, [languages_1.KnownLanguage.cpp, languages_1.KnownLanguage.java, languages_1.KnownLanguage.csharp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "a/b", version: undefined },
        { packName: "c/d", version: (0, semver_1.clean)("1.2.3") },
    ],
    [languages_1.KnownLanguage.java]: [
        { packName: "d/e", version: undefined },
        { packName: "f/g", version: (0, semver_1.clean)("1.2.3") },
    ],
});
(0, ava_1.default)("no language", parsePacksErrorMacro, ["a/b@1.2.3"], [languages_1.KnownLanguage.java, languages_1.KnownLanguage.python], /The configuration file "\/a\/b" is invalid: property "packs" must split packages by language/);
(0, ava_1.default)("invalid language", parsePacksErrorMacro, { [languages_1.KnownLanguage.java]: ["c/d"] }, [languages_1.KnownLanguage.cpp], /The configuration file "\/a\/b" is invalid: property "packs" has "java", but it is not one of the languages to analyze/);
(0, ava_1.default)("not an array", parsePacksErrorMacro, { [languages_1.KnownLanguage.cpp]: "c/d" }, [languages_1.KnownLanguage.cpp], /The configuration file "\/a\/b" is invalid: property "packs" must be an array of non-empty strings/);
...
(0, ava_1.default)("input only", parseInputAndConfigMacro, {}, " c/d ", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [{ packName: "c/d", version: undefined }],
});
(0, ava_1.default)("input only with multiple", parseInputAndConfigMacro, {}, "a/b , c/d@1.2.3", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "a/b", version: undefined },
        { packName: "c/d", version: "1.2.3" },
    ],
});
(0, ava_1.default)("input only with +", parseInputAndConfigMacro, {}, "  +  a/b , c/d@1.2.3 ", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "a/b", version: undefined },
        { packName: "c/d", version: "1.2.3" },
    ],
});
(0, ava_1.default)("config only", parseInputAndConfigMacro, ["a/b", "c/d"], "  ", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "a/b", version: undefined },
        { packName: "c/d", version: undefined },
    ],
});
(0, ava_1.default)("input overrides", parseInputAndConfigMacro, ["a/b", "c/d"], " e/f, g/h@1.2.3 ", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "e/f", version: undefined },
        { packName: "g/h", version: "1.2.3" },
    ],
});
(0, ava_1.default)("input and config", parseInputAndConfigMacro, ["a/b", "c/d"], " +e/f, g/h@1.2.3 ", [languages_1.KnownLanguage.cpp], {
    [languages_1.KnownLanguage.cpp]: [
        { packName: "e/f", version: undefined },
        { packName: "g/h", version: "1.2.3" },
        { packName: "a/b", version: undefined },
...
(0, ava_1.default)("input with two languages", parseInputAndConfigErrorMacro, {}, "c/d", [languages_1.KnownLanguage.cpp, languages_1.KnownLanguage.csharp], /multi-language analysis/);
(0, ava_1.default)("input with + only", parseInputAndConfigErrorMacro, {}, " + ", [languages_1.KnownLanguage.cpp], /remove the '\+'/);
(0, ava_1.default)("input with invalid pack name", parseInputAndConfigErrorMacro, {}, " xxx", [languages_1.KnownLanguage.cpp], /"xxx" is not a valid pack/);
// errors
