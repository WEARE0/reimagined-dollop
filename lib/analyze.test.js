...
(0, ava_1.default)("status report fields and search path setting", async (t) => {
    const mockLinesOfCode = Object.values(languages_1.KnownLanguage).reduce((obj, lang, i) => {
    ...
    function verifyLineCounts(tmpDir) {
        ...
        Object.keys(languages_1.KnownLanguage).forEach((lang, i) => {
    ...
    function verifyQuerySuites(tmpDir) {
        ...
        for (const lang of Object.values(languages_1.KnownLanguage)) {
            ...
            if (lang === languages_1.KnownLanguage.cpp) {
                t.deepEqual(readContents(packSuiteName), qlsPackContentCpp);
            }
            else if (lang === languages_1.KnownLanguage.java) {
